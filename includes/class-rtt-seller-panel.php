...
class RTT_Seller_Panel {
    ...
    public static function icon($name, $size = 20) {
        $icons = [
            ...
            'phone' => '<svg xmlns="http://www.w3.org/2000/svg" width="%s" height="%s" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>',
            'user-check' => '<svg xmlns="http://www.w3.org/2000/svg" width="%s" height="%s" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><polyline points="17 11 19 13 23 9"></polyline></svg>',
            'truck' => '<svg xmlns="http://www.w3.org/2000/svg" width="%s" height="%s" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="3" width="15" height="13"></rect><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"></polygon><circle cx="5.5" cy="18.5" r="2.5"></circle><circle cx="18.5" cy="18.5" r="2.5"></circle></svg>',
            'utensils' => '<svg xmlns="http://www.w3.org/2000/svg" width="%s" height="%s" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"></path><path d="M7 2v20"></path><path d="M21 15V2v0a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7"></path></svg>',
            'building' => '<svg xmlns="http://www.w3.org/2000/svg" width="%s" height="%s" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"></rect><path d="M9 22v-4h6v4"></path><path d="M8 6h.01"></path><path d="M16 6h.01"></path><path d="M12 6h.01"></path><path d="M12 10h.01"></path><path d="M12 14h.01"></path><path d="M16 10h.01"></path><path d="M16 14h.01"></path><path d="M8 10h.01"></path><path d="M8 14h.01"></path></svg>',
            'target' => '<svg xmlns="http://www.w3.org/2000/svg" width="%s" height="%s" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="6"></circle><circle cx="12" cy="12" r="2"></circle></svg>',
            'ticket' => '<svg xmlns="http://www.w3.org/2000/svg" width="%s" height="%s" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z"></path><path d="M13 5v2"></path><path d="M13 17v2"></path><path d="M13 11v2"></path></svg>',
...
- Menores de edad deben estar acompañados por un adulto responsable.');
    ...
    private function render_proveedores_shortcode() {
        ...
        $tipo_icons = [
            'guia' => self::icon('user-check', 16),
            'transporte' => self::icon('truck', 16),
            'restaurante' => self::icon('utensils', 16),
            'hotel' => self::icon('building', 16),
            'actividad' => self::icon('target', 16),
            'entrada' => self::icon('ticket', 16),
            'otro' => self::icon('package', 16)
        ];
        ...
        <div class="lista-container">
            ...
            <div class="provider-stats">
                ...
                <a href="<?php echo esc_url(add_query_arg('tipo', $key, $filter_base_url)); ?>" class="provider-stat <?php echo $tipo_filtro === $key ? 'active' : ''; ?>">
                    <div class="provider-stat-icon"><?php echo $tipo_icons[$key] ?? self::icon('package', 16); ?></div>
            ...
            <div class="app-layout">
                ...
                <aside class="sidebar">
                    ...
                    <div class="sidebar-user">
                        ...
                        <a href="<?php echo home_url('/' . self::PAGE_SLUG . '/logout/'); ?>" class="btn-logout-small" title="Cerrar sesión">
                    ...
                    <tr data-id="<?php echo $prov->id; ?>">
                        ...
                        <td data-label="Teléfono">
                            ...
                            <div class="provider-phone">
                                <span class="provider-phone-icon"><?php echo self::icon('phone', 14); ?></span>
                        ...
                        <td data-label="Estado">
                            <?php if ($prov->activo): ?>
                            <span class="badge badge-success"><?php echo self::icon('check', 12); ?> Activo</span>
                            <?php else: ?>
